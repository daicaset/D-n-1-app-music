...
public class AlbumSongActivity extends AppCompatActivity implements AlbumSongAdapter.Listener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        album = SongLoader.getAlbum(this, albumId);
    ...
    class LoadSongs extends AsyncTask<Void, Void, List<Song>> {
        ...
        protected List<Song> doInBackground(Void... voids) {
            return SongLoader.getAllAlbumSongs(context, albumId);
        }
    ...
    private void initView() {
        ...
        tvTitle.setText(album.getAlbumName());
        tvArtist.setText(album.getArtistName() + " - Bài hát: "+ album.getNumSong());
        ...
        try {
            ...
            ivImageSmall.setImageBitmap(bitmap);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
